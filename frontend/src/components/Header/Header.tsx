import {Badge, Box, Burger, Button, Divider, Flex, Image, Text, Tooltip} from "@mantine/core";
            ...
            <Flex align={'center'} justify={'space-between'} h="100%" px="md">
                {!user &&
                    <Flex align={'center'} justify={'center'} gap={10}>
                        <Image radius={'50%'} maw={25} height={'auto'} fit={'contain'} src={Logo}/>
                        <Text
                            fz={17}
                            ta="center"
                            fw={800}
                ...
                {user
                    ? <>
                        ...
                        <Tooltip position={'bottom-end'} label={'Areon ' + selectedChain?.type}>
                            <Badge
